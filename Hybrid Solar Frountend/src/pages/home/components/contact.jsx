            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">+94 71694345</div>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">hello@hybridenergy.com</div>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">No.145, Baseline Road, Negombo</div>
                </div>
              </div>
            </div>

            <div className="bg-card border border-border rounded-xl p-6">
              <h3 className="font-semibold text-foreground mb-2">Why get a quote?</h3>
